	...
	public void setPointState(int state) {
		...
		switch (state) {
			case Constants.POINT_STATE_NORMAL:
				this.image.setBackgroundResource(R.drawable.unlock_static);
				break;
			case Constants.POINT_STATE_SELECTED:
				this.image.setBackgroundResource(R.drawable.unlock_correct_green);
				break;
			case Constants.POINT_STATE_WRONG:
				this.image.setBackgroundResource(R.drawable.unlock_erro);
				break;
			default:
				break;
		}
